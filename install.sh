...
# ---------------------------------------------------------------------------
# Setup will ask vault path / language / cron / launchd interactively.
# If PM_SB_VAULT_ROOT / PM_SB_OUT_LANG / PM_SB_CRON_TIME / PM_SB_INSTALL_LAUNCHD
# are exported in the parent env (LLM-driven install flow), setup skips those
# prompts and uses the env values directly.
